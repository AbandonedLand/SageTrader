    ...
    @if($dexieOffer)
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                {{ $dexieOffer['quote']['from'] == 'xch' ? 'xch' : $asset['code'] }}
                            </td>
                            <td>
                            ...
                            <td>
                                {{ $dexieOffer['quote']['to'] == 'xch' ? 'xch' : $asset['code'] }}
                            </td>
                            <td>
            ...
            <div class="card-footer">
                <button class="btn btn-success float-right btn-sm" wire:click="takeOffer" wire:confirm="Are you sure you wish to execute this order?">Execute Order</button>
            </div>
        </div>
    @endif
    @endif
